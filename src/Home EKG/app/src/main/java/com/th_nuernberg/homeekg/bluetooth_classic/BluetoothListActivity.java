...
public class BluetoothListActivity extends Activity {
    ...
    public final static int total_bytes = 6;
    public final static int total_values = 1;
    ...
    static class ConnectedThread extends Thread {
        ...
        public void run() {
            ...
            while (true) {
                try {
                    while(readPos < total_bytes) {
                        // Read from the InputStream.
                        numBytes = mmInStream.read(mmBuffer, readPos, total_bytes - readPos);
                        if (numBytes == -1)
                    ...
                    Message readMsg = mHandler.obtainMessage(
                            Constants.MESSAGE_READ, readPos, -1,
                            mmBuffer);
