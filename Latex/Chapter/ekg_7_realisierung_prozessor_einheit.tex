...
\begin{enumerate}
    ...
    \item UART Display: Bei der Initialisierung der UART Verbindung zum Display, werden zunächst die Input- (RX) und Output- (TX) Pins festgelegt. Die Frequenz der MCU beträgt 20 MHz. Als Baudrate wurde 115200 $s^{-1}$ gewählt. Damit eine Verbindung der beiden Module besteht, muss die Baudrate sowohl beim Display als auch bei der MCU einprogrammiert werden. 
