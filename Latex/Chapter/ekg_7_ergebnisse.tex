...
$$  \textit{Eingangsamplitude} = \frac{\frac{\textit{ADC-Breite}}{\Delta \textit{Signalwerte}} \cdot \textit{3 V}}{\textit{Verstärkung der Filterschaltung}} $$ 

Es ergibt sich eine Eingangsamplitude von \SI{2,1}{\milli\volt}, was der EKG-Amplitude eines gesunden Menschen in der Ableitung Einthoven II entspricht. Der Test der Langzeit-Aufnahme lieferte 21 600 000 Werte. Dies entspricht einer durchschnittlichen Abtastrate von \SI{250}{\hertz}. 

Die Funktion zur Berechnung der Herzfrequenz im Kurzzeit-EKG liefert ein gleichmäßiges Ausgangssignal. Zur Überprüfung wurde der Mittelwert der Herzfrequenz über eine Minute berechnet und mit dem analog gemessenen Puls am Handgelenk verglichen, wobei beide Werte übereinstimmten. Dies gilt jedoch nur für ein Ruhe-EKG, bei dem der Anwender sich möglichst wenig bewegt und gleichmäßig atmet. Bei Störungen von mehr als \SI{6}{\sec} Dauer, führen die Bewegungsartefakte zu einer Verfälschung der Pulsrate. 
...
Die maximale Akkulaufzeit im Lagerzustand (5 V-DCDC ausgeschaltet) bis zur Entladegrenze von 20\% berechnet sich zu
...
Nach der Bilanzierung aller Kosten für Material und Herstellung in der Großproduktion, ergibt sich ein Gesamtpreis von 81,66 €. Die Herstellungskosten liegen somit 68,34 € unter dem gewünschten Budget. Kosten für Entwicklungsarbeit wurden noch nicht berücksichtigt. (siehe Dokumentation/Kostenplanung)